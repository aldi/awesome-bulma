...
- [BulmaJS](https://github.com/VizuaaLOG/BulmaJS) - JavaScript helpers for interactive Bulma components
- [@cityssm/bulma-js](https://github.com/cityssm/bulma-js) - JavaScript helpers for Bulma websites
- [bulma-calendar](https://github.com/michael-hack/bulma-calendar) - Display a calendar with different colors and sizes
- [bulma-timeline](https://github.com/bulma-extensions/bulma-timeline) - Display a vertical timeline, in different colors, sizes, and states
- [bulma-megamenu](https://github.com/hunzaboy/bulma-megamenu/) - Bulma extension to make Mega Menus
- [bulma-steps](https://github.com/bulma-extensions/bulma-steps) - Display steps for a process with different colors, sizes, and states
- [bulma-switch](https://github.com/bulma-extensions/bulma-switch) - Display the classic checkbox as a switch button with different colors, sizes, and states
- [bulma-pageloader](https://github.com/bulma-extensions/bulma-pageloader) - Display a page-loader to inform users that content is loading, in different colors
- [bulma-checkradio](https://github.com/bulma-extensions/bulma-checkradio) - Make classic checkbox and radio sexier with different colors, sizes, and states
- [bulma-pricingtable](https://github.com/bulma-extensions/bulma-pricingtable) - Display pricing tables with different colors and styles
- [bulma-accordion](https://www.jsdelivr.com/package/npm/bulma-accordion) - A simple accordion extension for Bulma
- [bulma-slider](https://github.com/bulma-extensions/bulma-slider) - Display a classic slider with different colors, sizes, and states
- [bulma-ribbon](https://github.com/bulma-extensions/bulma-ribbon) - Bulma's extension to show a ribbon on boxes
- [bulma-quickview](https://github.com/bulma-extensions/bulma-quickview) - Display a quick view of data without leaving the current page
- [bulma-carousel](https://github.com/bulma-extensions/bulma-carousel) - A simple carousel/slider extension for Bulma
- [bulma-iconpicker](https://github.com/bulma-extensions/bulma-iconpicker) - Display an input as an Icon Picker to ease the user icon selection
...
- [bulma-divider](https://github.com/bulma-extensions/bulma-divider) - Display a vertical or horizontal divider to segment your design
- [bulma-badge](https://github.com/bulma-extensions/bulma-badge) - Display a badge element in front of Bulma's element in different colors
- [bulma-tooltip](https://github.com/bulma-extensions/bulma-tooltip) - Display a tooltip attached to any kind of element with different positioning
- [bulma-toast](https://github.com/rfoel/bulma-toast/) - Bulma's pure JavaScript extension to display toasts
- [bulma-tagsinput](https://github.com/bulma-extensions/bulma-tagsinput) - Modernize an add interaction on input of tags type
